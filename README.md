...
Requirement:
-Please disable the AUTO-ROTATE option on your Android device.
-Make sure the device is connected to the Internet.
-Also, make sure the location service is enabled.

The TransformMe.apk is included in the same directory as the README file.
To run the application, copy this apk file in an Anroid device and install it.
